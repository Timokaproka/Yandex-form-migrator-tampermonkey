// ==UserScript==
// @name         Yandex Forms Migrator Single (V9.7)
// @namespace    http://tampermonkey.net/
// @version      9.7
// @description  Экспорт/импорт яндекс форм (с системным логированием процессов)
// @author       timokaproka
...
(function() {
    ...
    async function uploadImageDirect(attachmentObj, ctx, targetSurveyId) {
        ...
        try {
            console.log(`[Yandex Forms Migrator Single] Загрузка изображения: ${attachmentObj.name || "image.jpg"}`);
